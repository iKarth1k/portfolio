...
const SKILLS_DATA = [
  {
    ...
    projects: ["AI Voice Call Assistant", "Custom Models"],
    orbit: "inner",
  },
  {
    name: "LangChain",
    proficiency: 85,
    experience: "Advanced",
    projects: ["Chatdocs.ai", "Hashtree.ai"],
    orbit: "inner",
  },
  {
    name: "LLMs / Prompting",
  ...
  },
  {
    ...
    proficiency: 75,
    experience: "Intermediate",
    projects: ["AI Voice Call Assistant (Whisper, CosyVoice2)"],
    orbit: "outer",
  },
  {
    ...
    proficiency: 85,
    experience: "Advanced",
    projects: ["Chatdocs.ai API", "Voice Pipeline"],
    orbit: "outer",
  },
  {
    name: "Docker / Deploy",
  ...
  },
  {
    ...
    proficiency: 75,
    experience: "Intermediate",
    projects: ["Data Storage for AI Apps"],
    orbit: "outer",
  },
  {
    name: "React / Next.js",
    proficiency: 70,
    experience: "Intermediate",
    projects: ["AI App Dashboards & Fullstack"],
    orbit: "outer",
  },
  {
    name: "Git / GitHub",
...
export function SkillsSection() {
  ...
  const handleCanvasHover = useCallback(
    (e: React.MouseEvent) => {
      ...
      if (sunDist < 40) {
        if (hoveredSkill?.name !== CORE_SKILL.name) {
          setHoveredSkill(CORE_SKILL)
        }
        return
      }
  ...
  useEffect(() => {
    ...
    const animate = () => {
      ...
      ctx.fillText("PY", centerX, centerY)
