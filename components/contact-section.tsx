...
const SOCIAL_LINKS = [
  {
    name: "GitHub",
    icon: Github,
    url: "https://github.com/iKarth1k",
    handle: "@iKarth1k",
  },
  {
    name: "LinkedIn",
    icon: Linkedin,
    url: "https://www.linkedin.com/in/iKarth1k/",
    handle: "/in/iKarth1k",
  },
  {
    name: "X (Twitter)",
    icon: Twitter,
    url: "https://x.com/iKarth1k",
    handle: "@iKarth1k",
  },
  {
    name: "Dev.to",
    icon: DevTo,
    url: "https://dev.to/karth1k",
    handle: "karth1k",
  },
];
      ...
      >
        ...
        >
          ...
          <div className="flex items-center gap-2 px-4 py-3 bg-[#111] border-b border-white/5">
            ...
            <span className="flex-1 text-center text-xs font-mono text-mist/40">
              karthik@neural-link ~ comm_channel
            </span>
          </div>
        ...
        >
          <p className="text-sm text-mist/40 font-mono">
            Designed & Developed by <span className="text-cyan">KARTHIK</span>
          </p>
