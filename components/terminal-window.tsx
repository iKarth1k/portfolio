            ...
            case "whoami":
                addResponse([
                    <div key="whoami" className="flex flex-col gap-1">
                        <span className="text-white font-bold"><Typewriter text="karthik@workspace" speed={5} /></span>
                        <span className="text-gray-300"><Typewriter text="AI Engineer" delay={50} speed={5} /></span>
                        <span className="text-gray-400 italic"><Typewriter text="building scalable LLM and RAG systems" delay={100} speed={5} /></span>
                        <br />
            ...
            >
                ...
                <div className="h-8 bg-[#151515] border-b border-white/5 flex items-center justify-between px-4 select-none shrink-0">
                    ...
                    <div className="flex items-center gap-2 text-[10px] text-gray-500 font-medium tracking-wider opacity-60">
                        ...
                        <span>root@karthik:~/welcome</span>
                    </div>
                    <div className="w-10" />
                </div>
                        ...
                        {!isBooting && (
                            ...
                            >
                                ...
                                <div className="flex items-center gap-2 whitespace-nowrap overflow-hidden">
                                    <span className="text-[#56b6c2] hidden sm:inline">root@karthik</span>
